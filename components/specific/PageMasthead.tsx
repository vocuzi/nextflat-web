    ...
    <section className="grid grid-cols-1 mx-3">
      <div className="bg-green-300 border border-green-300 text-slate-900 p-6 flex flex-col rounded-lg">
        ...
        <div className="flex flex-col md:flex-row gap-2 justify-start mt-6">
          <NfBtn size={'sm'} icon={<BellPlus size={18} className="text-green-300" />}>Setup Whatsapp Alerts</NfBtn>
          <NfBtn size={'sm'} variant={'outline'} icon={<HousePlus size={20} />} className="bg-slate-900/5">Post Your Listing</NfBtn>
        </div>
      </div>
    </section>
  );
